            ...
            <div class="well well-lg">
                <form action="" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="checkbox-inline">
                                <input type="checkbox" name="hobby[]" <?php if($hobby == 'Gardening')  echo 'checked' ?> value="Gardening"> Gardening
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="hobby[]"  <?php if($hobby == 'Travelling')  echo 'checked' ?> value="Travelling"> Travelling
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="hobby[]"  <?php if($hobby == 'Painting')  echo 'checked' ?> value="Painting"> Painting
                            </label>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="hobby[]" <?php if($hobby == 'Fishing')  echo 'checked' ?> value="Fishing"> Fishing
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="3" name="comment" value="<?php echo $row['comment'];?>" ></textarea>
                        </div>
                    </div>
                    <div class="form-group">
